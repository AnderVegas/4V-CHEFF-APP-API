 ...
 */
final class Version20240424101158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, vote_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, number_diner INT NOT NULL, INDEX IDX_DA88B13772DCDAFC (vote_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, id_recipe_id INT DEFAULT NULL, rate NUMERIC(5, 1) NOT NULL, INDEX IDX_5A108564D9ED1E33 (id_recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE ingredient ADD CONSTRAINT FK_6BAF787059D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id)');
        $this->addSql('ALTER TABLE recipe ADD CONSTRAINT FK_DA88B13772DCDAFC FOREIGN KEY (vote_id) REFERENCES vote (id)');
        ...
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A108564D9ED1E33 FOREIGN KEY (id_recipe_id) REFERENCES recipe (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP FOREIGN KEY FK_DA88B13772DCDAFC');
        ...
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A108564D9ED1E33');
